<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Usuarios.aspx.cs" Inherits="AG.Usuarios" %>
  ...
  <div class="content-wrapper">
    ...
    <script type="text/javascript">
        function erro() {
            ...
            toastr["error"]("Não é possível deletar esse usuario, pois esta sendo utilizado no cadastro de um ou mais Itens. ", "Erro")
      };
    </script>
